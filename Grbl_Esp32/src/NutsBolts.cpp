...
//从字符串中提取浮点值。下面的代码大致基于
// avr-libc strtod()函数由Michael Stumpf和Dmitry Xmelkov和许多自由
//可用的转换方法的例子，但已高度优化的Grbl。对已知的
// CNC应用，典型的十进制值期望在E0到E-4的范围内。
// g码官方不支持科学记数法，但'E'字符可以
//在某些CNC系统上是g码字。所以，'E'符号不会被识别。
//注意:感谢Radu-Eosif Mihailescu识别了使用strtod()的问题。
